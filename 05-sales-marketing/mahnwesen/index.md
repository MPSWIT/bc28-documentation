...
> 📋 Nächstes: [Kundenverwaltung →]({{ '/05-sales-marketing/kunden/' | relative_url }})
...
| [← Zurück zur Übersicht]({{ '/05-sales-marketing/' | relative_url }}) | [Kundenverwaltung →]({{ '/05-sales-marketing/kunden/' | relative_url }}) |
