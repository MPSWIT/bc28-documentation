...
> 📋 Nächstes: [Entwickler-Referenz →]({{ '/05-sales-marketing/entwickler/' | relative_url }})
...
| [← Zurück zur Übersicht]({{ '/05-sales-marketing/' | relative_url }}) | [Entwickler-Referenz →]({{ '/05-sales-marketing/entwickler/' | relative_url }}) |
