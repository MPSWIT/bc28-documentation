...
> 📋 Nächstes: [Preise & Rabatte →]({{ '/06-purchasing/preise-rabatte/' | relative_url }})
...
| [← Zurück zur Übersicht]({{ '/06-purchasing/' | relative_url }}) | [Preise & Rabatte →]({{ '/06-purchasing/preise-rabatte/' | relative_url }}) |
