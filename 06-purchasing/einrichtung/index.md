...
> 📋 Nächstes: [Einkaufsbelege →]({{ '/06-purchasing/einkaufsbelege/' | relative_url }})
...
| [← Zurück zur Übersicht]({{ '/06-purchasing/' | relative_url }}) | [Einkaufsbelege →]({{ '/06-purchasing/einkaufsbelege/' | relative_url }}) |
