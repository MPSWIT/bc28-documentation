...
> 📋 Nächstes: [Entwickler-Referenz →]({{ '/06-purchasing/entwickler/' | relative_url }})
...
| [← Zurück zur Übersicht]({{ '/06-purchasing/' | relative_url }}) | [Entwickler-Referenz →]({{ '/06-purchasing/entwickler/' | relative_url }}) |
